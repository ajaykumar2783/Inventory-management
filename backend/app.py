...
from models import db, User, Material, Supplier
...
with app.app_context():
    ...
    if Supplier.query.count() == 0:
        ...
        s2 = Supplier(
            supplier_name="Color Ink Traders",
            phone="9988776655",
    ...
    if Material.query.count() == 0:
        ...
        sample_materials = [
            Material(
                material_name="A4 Inner Pages",
                material_type="Inner Pages",
                unit="ream",
                quantity=50,
                min_stock=10,
                unit_price=250,
            ...
            Material(
                material_name="Glossy Outer Cover",
                material_type="Outer Pages",
                unit="bundle",
                quantity=8,
                min_stock=10,
                unit_price=500,
                remarks="For notebooks",
                supplier_id=suppliers[0].id
            ),
            Material(
                material_name="Black Ink",
                material_type="Ink",
                unit="litre",
                quantity=20,
                min_stock=5,
                unit_price=900,
                remarks="Offset print",
                supplier_id=suppliers[1].id
            ),
            Material(
                material_name="Binding Gum",
                material_type="Shared Material",
                unit="kg",
                quantity=0,
                min_stock=3,
                unit_price=300,
                remarks="Shared usage",
                supplier_id=suppliers[1].id
            ),
        ]

        db.session.add_all(sample_materials)
        db.session.commit()
